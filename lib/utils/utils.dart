...
List<Map> planItems = [
  {'title': 'Название плана', 'placeholder': 'Введите название плана', 'value': ''},
  {'title': 'Площадь объекта', 'placeholder': 'Введите площадь объекта', 'value': ''},
  {'title': 'Начальная стоимость', 'placeholder': 'Введите начальную стоимость', 'value': ''},
  {'title': 'Дата начала расчета', 'placeholder': 'Введите дату начала расчета', 'value': ''},
  {'title': 'Дата окончания расчета', 'placeholder': 'Введите дату окончания расчета', 'value': ''},
  {'title': 'Арендная ставка', 'placeholder': 'Введите арендную ставку', 'value': ''},
  {'title': 'Изменение арендной ставки в год', 'placeholder': 'Введите изменение арендной ставки', 'value': ''},
  {'title': 'Коэффициент капитализации', 'placeholder': 'Введите коэффициент капитализации', 'value': ''},
  {'title': 'Недозагрузка', 'placeholder': 'Введите недогруз', 'value': ''},
];
...
List<Map> totalTableItems = [
  {'title': 'Площадь, кв.м', 'objects': ['100', '100', '200']},
  {'title': 'Время покупки', 'objects': ['12.03.2019', '12.03.2019', '']},
  {'title': 'Цена покупки, тыс. руб.', 'objects': ['1 121', '1 121', '2 121']},
  {'title': 'Цена покупки, тыс. руб./кв.м', 'objects': ['23', '13', '54']},
  {'title': 'Стоимость на 07.2018, тыс. руб.', 'objects': ['1 344', '1 483', '2 340']},
  {'title': 'Стоимость на 12.2020, тыс. руб. (или момент продажи)', 'objects': ['1 344', '1 483', '2 342']},
  {'title': 'Cтоимость на 07.2018, тыс. руб./кв.м', 'objects': ['24', '23', '32']},
  {'title': 'Cтоимость на 12.2020, тыс. руб./кв.м (или момент продажи)', 'objects': ['100', '100', '200']},
  {'title': 'Изменение стоимости 2018/2020', 'objects': ['10%', '10%', '10%']},
  {'title': 'Доход на лето 2018, тыс. руб./год', 'objects': ['1 000', '1 000', '2 000 000 000']},
  {'title': 'Доход на лето 12.2020, тыс. руб./год', 'objects': ['2 494', '2 343', '223 030']},
  {'title': 'Рост дохода, %, 2018-2020', 'objects': ['10%', '10%', '10%']},
  {'title': '«Доходность» отношение ГАП/ рыночная стоимость, % 2020', 'objects': ['10%', '10%', '10%']},
  {'title': 'Средний прирост стоимости в год, % ', 'objects': ['10%', '10%', '10%']},
  {'title': 'Доли', 'objects': ['100', '100', '2']},
];
